...
use Encore\Admin\Table\Filter\Layout\Layout;
use Encore\Admin\Table\Filter\Scope;
...
class Filter implements Renderable
{
     ...
     * @var string
     */
    public $view = 'admin::table.filter.container';
    ...
    /**
     * Generate a filter object and add to table.
     *
     * @param string $method
     * @param array  $arguments
     *
